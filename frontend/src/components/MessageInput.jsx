    ...
    <div className="p-4 border-t border-slate-700/50">
      ...
      >
        <input
          ...
          className="flex-1 bg-slate-800/50 border border-slate-700/50 rounded-lg py-2 px-3 sm:px-4 min-w-0"
        />
        <input
          type="file"
          accept="image/*"
        ...
        <button
          ...
          className={`bg-slate-800/50 text-slate-400 hover:text-slate-200 rounded-lg px-3 sm:px-4 py-2
                        transition-colors ${
